 ...
 */
class CRM_Flags_Upgrader_Base {

  /**
   * @var CRM_Flags_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Flags_Upgrader(
        'flags',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Flags_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Flags_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
